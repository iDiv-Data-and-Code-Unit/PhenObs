...
const multipleGardensUserLogin = require('./login/multipleGardensAssignedUser.js');

test.describe('Home page', () => {
    test.beforeEach(multipleGardensUserLogin);
    ...
    test('Jumbotron details', async ({ page }) => {
        ...
        await expect(page.locator('div.jumbotron-fluid.custom-jumbotron p')).toHaveText('Multiple gardens are assigned to the user. Please assign only one subgarden per user. Assigned gardens are: \'Subgarden\', \'Garden\'');
    });
});
