...
module.exports = async ({ page }) => {
    ...
    // Fill in credentials
    await page.locator('#id_login').fill(process.env.E2E_NO_SUBGARDEN_USERNAME);
    await page.locator('#id_password').fill(process.env.E2E_NO_SUBGARDEN_PASSWORD);
    ...
    await expect(entries['loggedIn']).toStrictEqual('no_subgarden');
