...
module.exports = async ({ page }) => {
    ...
    // Fill in credentials
    await page.locator('#id_login').fill(process.env.E2E_ADMIN_USERNAME);
    await page.locator('#id_password').fill(process.env.E2E_ADMIN_PASSWORD);
    ...
    await expect(entries['loggedIn']).toStrictEqual('admin');
